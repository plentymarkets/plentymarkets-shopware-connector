...
namespace PlentyConnector\Connector\ServiceBus\Command\Variation;

use Assert\Assertion;
use PlentyConnector\Connector\ServiceBus\Command\RemoveCommandInterface;

/**
 * Class RemoveVariationCommand.
 */
class RemoveVariationCommand implements RemoveCommandInterface
{
    /**
     * @var string
     */
    ...
    /**
     * RemoveVariationCommand constructor.
     *

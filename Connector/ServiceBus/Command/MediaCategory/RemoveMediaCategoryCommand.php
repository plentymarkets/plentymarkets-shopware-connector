...
namespace PlentyConnector\Connector\ServiceBus\Command\MediaCategory;

use Assert\Assertion;
use PlentyConnector\Connector\ServiceBus\Command\RemoveCommandInterface;

/**
 * Class RemoveMediaCategoryCommand.
 */
class RemoveMediaCategoryCommand implements RemoveCommandInterface
{
    /**
     * @var string
     */
    ...
    /**
     * RemoveMediaCategoryCommand constructor.
     *

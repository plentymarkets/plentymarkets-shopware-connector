...
namespace PlentyConnector\Connector\ServiceBus\Command\Stock;
...
/**
 * Class HandleStockCommand.
 */
class HandleStockCommand implements HandleCommandInterface
{
    /**
     * @var string
     */
    ...
    /**
     * HandleStockCommand constructor.
     *

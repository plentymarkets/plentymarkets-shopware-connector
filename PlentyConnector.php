...
use PlentyConnector\DependencyInjection\CompilerPass\DefinitionCompilerPass;
...
use PlentyConnector\DependencyInjection\FileLoaderTrait;
...
class PlentyConnector extends Plugin
{
    ...
    {
        /**
         * @var DatabaseInstaller $databaseInstaller
         */

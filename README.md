...
- [Update auf Version 1.4.0](#update-auf-version-140)
	- [Umstellung von github auf Community Store](#umstellung-von-github-auf-community-store)
	- [Nutzung von Subshops](#nutzung-von-subshops)
- [Einrichtung](#einrichtung)
	...
	- [shopware](#shopware)
		...
		- [Einstellungen](#einstellungen)
			...
			- [Initialer Export](#initialer-export)
		- [Mapping](#mapping)
			...
			- [Länder](#l%C3%A4nder)
			- [Shops](#shops)
			- [Partner / Auftragsherkunft](#partner--auftragsherkunft)
...
Ein root-Server mit vollem Zugriff auf alle Konfigurationsdateien wird für den reibungslosen Datenaustausch vorrausgesetzt. Auf Managed-Servern oder bei anderen Hosting Angeboten ist es idR. nicht möglich, die erforderlichen Konfigurationen vorzunehmen oder die Cronjobs per Konsole zu starten. Außerdem sollten Sie Erfahrung im Umgang mit Linux haben.

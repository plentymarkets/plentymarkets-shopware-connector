...
class PlentymarketsGarbageCollector
{
    ...
    {
        $dirty = [
            'plenty_mapping_attribute_group' => ['id', 's_article_configurator_groups'],
            'plenty_mapping_attribute_option' => ['id', 's_article_configurator_options'],
            'plenty_mapping_category' => ['id', 's_categories'],
            'plenty_mapping_country' => ['id', 's_core_countries'],
            'plenty_mapping_currency' => ['currency', 's_core_currencies'],
            'plenty_mapping_customer' => ['id', 's_order_billingaddress'],
            'plenty_mapping_customer_billing_address' => ['id', 's_user_billingaddress'],
            'plenty_mapping_customer_class' => ['id', 's_core_customergroups'],
            'plenty_mapping_item' => ['id', 's_articles'],
            'plenty_mapping_item_variant' => ['id', 's_articles_details'],
    //		'plenty_mapping_item_bundle' => array('id', 's_articles_bundles'),
            'plenty_mapping_measure_unit' => ['id', 's_core_units'],
            'plenty_mapping_method_of_payment' => ['id', 's_core_paymentmeans'],
            'plenty_mapping_producer' => ['id', 's_articles_supplier'],
            'plenty_mapping_property_group' => ['id', 's_filter'],
            'plenty_mapping_referrer' => ['id', 's_emarketing_partner'],
            'plenty_mapping_shipping_profile' => ['id', 's_premium_dispatch'],
            'plenty_mapping_shop' => ['id', 's_core_shops'],
            'plenty_mapping_vat' => ['id', 's_core_tax'],
            'plenty_mapping_order_status' => ['id', 's_core_states'],
            'plenty_mapping_payment_status' => ['id', 's_core_states'],
        ];
    ...
    protected function pruneItems()
    {
        ...
        foreach ($Result as $item) {
            ...
            } elseif ($actionId == self::ITEM_ACTION_DELETE) {
                try {

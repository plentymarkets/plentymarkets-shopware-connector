 ...
 */
class PlentySoapRequest_UpdateCategoriesVisibilities
{
	...
	/**
	 * @var ArrayOfPlentysoaprequestobject_updatecategoriesvisibilities
	 */
	public $UpdateCategoriesVisibilities;
}

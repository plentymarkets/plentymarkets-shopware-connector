...
class PlentymarketsExportEntityCustomer
{
     ...
     * @var array
     */
    protected static $mappingFormOfAddress = [
        'mr' => 0,
        'ms' => 1,
        'company' => 2,
    ];
    ...
    protected function exportCustomer()
    {
        ...
        try {
            ...
            } elseif ($this->BillingAddress instanceof \Shopware\Models\Order\Billing) {
        ...
        $Request_SetCustomers->Customers = [];
    ...
    protected function exportDeliveryAddress()
    {
        ...
        $Request_SetCustomerDeliveryAddresses->DeliveryAddresses = [];
